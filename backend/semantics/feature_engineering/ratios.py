...
MEANINGFUL_PAIRS = [
    # Vendite / Stock
    (["sold", "venduto", "vendite", "sales"],     ["stock", "available", "disponibile", "inventory"],  "sell_through_rate"),
    # Ordini / Clienti
        ...
        for num_kws, den_kws, ratio_name in MEANINGFUL_PAIRS:
            ...
            for num in numerators:
                for den in denominators:
                    ...
                    features.append({
                        "name": ratio_name if ratio_name not in [f["name"] for f in features] else f"{ratio_name}_{num}",
            ...
            for q1, q2 in itertools.combinations(sorted_qty, 2):
                ...
                if pair not in used_pairs:
                    ...
                    features.append({
                        ...
                        "confidence": round((semantics[q1]["confidence"] + semantics[q2]["confidence"]) / 2 * 0.7, 3),
                        "status": "pending",
                    })
                    count += 1
